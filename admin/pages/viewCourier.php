...
<div class="card-header ">
    ...
    <div class="card-body ">
                                ...
                                <label>Has Arrived</label>
                                <div class="form-group">
                                    <select name="has-arrived" id="has_arrived" class="form-control">
                                ...
                                <div class="form-group">
                                    <input value="<?=$current_location?>" id="current_location" type="text" class="form-control">
                                </div>
...
<script>
    document.getElementById('has_arrived').value = "<?=$has_arrived?>";
    console.log(<?=$has_arrived?>)
